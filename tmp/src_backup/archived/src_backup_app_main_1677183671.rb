...
class Game
  ...
  def render_player
    if player.action == :standing
      ...
      render_jump_animation
    render_circle_animation('sprites/player/idle.png', 10) if player.action == :standing
    render_circle_animation('sprites/player/run.png', 8)  if player.action == :running
    render_jump_animation if player.action == :jumping
