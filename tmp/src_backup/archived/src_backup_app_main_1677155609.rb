...
def playerRun(args)
  ...
  args.state.player.is_jumping = true if args.inputs.up
  args.state.player.y += 5 if args.state.player.is_jumping
  args.state.player.is_jumping = false if args.state.player.y >= 100
