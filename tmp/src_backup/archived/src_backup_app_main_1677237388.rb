...
class Game
  ...
  def initialize(args)
    ...
    outputs.debug << [player.x, player.y, 10, 10, 255, 0, 0]
    outputs.debug << [player.x, player.y + player.size, 10, 10, 255, 0, 0]
    outputs.debug << [player.x + player.size, player.y, 10, 10, 255, 0, 0]
    outputs.debug << [player.x + player.size, player.y + player.size, 10, 10, 255, 0, 0]
