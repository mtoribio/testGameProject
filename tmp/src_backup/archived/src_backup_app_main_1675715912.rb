...
class MenuState
  ...
  def run(args)
    ...
    args.outputs.labels << { x: 500, y: 300, text: 'Press start', size_enum: 20, alignment_enum: 0, r: 255, g: 255, b: 255, a: 100, font: 'fonts/VT323-Regular.ttf' } if args.state.tick_count.odd?
  end
end
